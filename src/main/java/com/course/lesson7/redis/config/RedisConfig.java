...
public class RedisConfig extends CachingConfigurerSupport {
    ...
    public CacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        cacheConfigurations.put("categories", defaultConfig.entryTtl(Duration.ofMinutes(60)));
        cacheConfigurations.put("analytics", defaultConfig.entryTtl(Duration.ofMinutes(2)));
        cacheConfigurations.put("leaderboard", defaultConfig.entryTtl(Duration.ofMinutes(1)));
